...
const int ROT_BTN_PIN = 2;
const int ROT_ENC_A_PIN = 3;
const int ROT_ENC_B_PIN = 4;

const int IO_1_PIN = 9; // Bluetooth
const int IO_2_PIN = 5; // Vent

// LEDs
const int PCELL_LED_PIN = 16;
const int CYCLO_LED_PIN = 17;
const int VENT_LED_PIN = 14;

//const int PCELL_LED_COUNT = 15;
const int PCELL_LED_COUNT = 8;
...
void attachCmdMessengerCallbacks() {
    ...
    cmdMessenger.attach(eventSerialLog, onSerialLog);
}
...
void onSerialLog() {
    DEBUG_SERIAL.println(cmdMessenger.readStringArg());
}
